...
const lincs = document.querySelectorAll(".menu-item > a");
for (let i = 0; i < lincs.length; i++) {
    lincs[i].onclick = function () {
        document.getElementById(lincs[i].getAttribute("data-link")).scrollIntoView({behavior: "smooth"});
    }
}
